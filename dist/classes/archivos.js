...
exports.EliminarJugador = exports.ModificarJugador = exports.InsertarJugadores = exports.ModDataEmpl = exports.ModificarEmpleado = exports.InsertarEmpleado = exports.InsertarHooras = exports.InsertarPlanilla = exports.InsertarinfoAdjuntos = void 0;
const fs = require('fs');
var fecha = new Date();
var fechArchivodia = '';
var fechArchivo = '';
...
// ===========================================================  EMPLEADOS ==============================================================================
// =====================================================================================================================================================
function InsertarEmpleado(valor) {
    return new Promise((resolve, reject) => {
        var i = 0;
        //console.log(count);
        //var id = setInterval(()=>{
...
exports.InsertarEmpleado = InsertarEmpleado;
function ModificarEmpleado(valor) {
    return new Promise((resolve, reject) => {
        console.log(valor);
        const { Id_Empleado, nombre, apellido, Id_depto, Id_puesto, fecha_ing, genero, identidad, fecha_nac, edad, direccion, telefono, dic_indc, status, planilla, tiposal, salario, salHora, temporal, seccion, contacto, tel_contacto } = valor;
...
//  ==================================================================================================================================================
//  ==================================================================================================================================================
function ModDataEmpl(valor, user) {
    var reg = 0;
    var count = valor.length;
    return new Promise((resolve) => {
        ...
        var id = setInterval(() => {
            ...
            environment_1.connection.query(query1, (err, results, fields) => {
                if (err) {
                    console.log("Error al agregar nuevo rgistro: " + err);
                }
                console.log("Modificado");
...
exports.ModDataEmpl = ModDataEmpl;
// =====================================================================================================================================================
// ===========================================================  JUGADORES ==============================================================================
// =====================================================================================================================================================
